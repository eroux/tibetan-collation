...
testOrder("ག གྭ གྱ གྲ གྲྭ གླ དགྱ དགྲ བགྱ བགྲ བགླ མགྱ མགྲ འགྱ འགྲ རྒ རྒྱ ལྒ སྒ སྒྱ སྒྲ བརྒ བརྒྱ བསྒ བསྒྱ བསྒྲ", "letter ག")
...
testOrder("ད དྭ དྲ དྲྭ མདྲོན འདྲ རྡ ལྡ སྡ བརྡ བལྡ བསྡ", "letter ད")
...
testOrder("ཀཀ ཀཁ ཀག ཀགས ཀང ཀངས ཀཉ ཀཏ ཀཊ ཀཐ ཀཋ ཀད ཀཌ ཀན ཀཎ ཀནད ཀཔ ཀཕ ཀབ ཀབས ཀམ ཀཾ ཀམས ཀཙ ཀཚ ཀཛ ཀཝ ཀའ ཀའང ཀའན ཀའམ ཀའར ཀའས ཀའི ཀའིམ ཀའིའོ ཀའིས ཀའུ ཀའུའི ཀའུའིའོ ཀའུར ཀའུས ཀའེ ཀའོ ཀཡ ཀར ཀརད ཀལ ཀལད ཀཤ ཀཥ ཀས ཀཧ", "suffixes (Di Jiang) (fixed and augmented)")
